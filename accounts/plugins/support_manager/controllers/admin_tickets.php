	...
	public function add() {
		...
		if (!empty($this->post)) {
			...
			if ($errors) {
				...
				$additional_tags = array('SupportManager.ticket_updated' => array('update_ticket_url' => $this->Html->safe($hostname . $this->client_uri . "plugin/support_manager/client_tickets/reply/" . $ticket->id . "/")));
