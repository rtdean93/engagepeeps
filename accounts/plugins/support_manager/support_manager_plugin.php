...
class SupportManagerPlugin extends Plugin {
	...
	public function getName() {
		return Language::_("SupportManagerPlugin.name", true);	
	}
	...
	public function uninstall($plugin_id, $last_instance) {
		...
		$cron_task_run = $this->CronTasks->getTaskRunByKey("poll_tickets", "support_manager");
		...
		if ($last_instance) {
			...
			$cron_task = $this->CronTasks->getByKey("poll_tickets", "support_manager");
			if ($cron_task)
