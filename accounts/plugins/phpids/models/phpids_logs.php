...
class PhpidsLogs extends PhpidsModel {
	...
	public function add(array $vars) {
		...
		$fields = array('company_id', 'name', 'value', 'uri', 'user_id',
	 ...
	 */
	public function getList($page=1, array $order=array('date_added'=>"DESC")) {
	...
	private function getLogs() {
		return $this->Record->select(array("log_phpids.*"))->from("log_phpids")->
