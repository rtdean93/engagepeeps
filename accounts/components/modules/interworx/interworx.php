...
class Interworx extends Module {
	...
	public function addService($package, array $vars=null, $parent_package=null, $parent_service=null, $status="pending") {
		...
		// Set missing username/email address
		if (array_key_exists('interworx_domain', $vars)) {
			Loader::loadModels($this, array("Clients"));
			
			// Generate a username
			if (empty($vars['interworx_username']))
				$vars['interworx_username'] = $this->generateUsername($vars['interworx_domain']);
			// Generate a password
			...
			if (empty($vars['interworx_email']) && isset($vars['client_id']) && ($client = $this->Clients->get($vars['client_id'], false)))
		...
		return array(
			...
			array(
				...
				'value' => (isset($result->reseller_id) ? $result->reseller_id : 0),
				'encrypted' => 0
			),
			array(
	...
	public function editService($package, $service, array $vars=null, $parent_package=null, $parent_service=null) {
		...
		if ($vars['use_module'] == "true") {
			...
			$input = array(
				'password' => (isset($delta['interworx_password']) ? $delta['interworx_password'] : $service_fields->interworx_password),
				'confirm_password' => (isset($delta['interworx_password']) ? $delta['interworx_password'] : $service_fields->interworx_password),
		...
		$fields = array("interworx_domain", "interworx_username", "interworx_email", "interworx_password");
