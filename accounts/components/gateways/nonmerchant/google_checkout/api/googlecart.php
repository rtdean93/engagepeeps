...
//          echo get_class($item->merchant_private_item_data);
          if($item->merchant_private_item_data instanceof MerchantPrivate) {
...
//      BETA Subscription Tags
        if($item->subscription){
          ...
          if(!empty($sub->recurrent_item)){
            ...
            if($sub->subscription_type == 'google'){
              ...
              //          echo get_class($item->merchant_private_item_data);
                if($recurrent_item->merchant_private_item_data instanceof MerchantPrivate) {
      ...
      if(!empty($this->merchant_private_data)) {
