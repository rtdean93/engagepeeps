...
class Offline extends NonmerchantGateway {
	...
	public function __construct() {
		...
		Language::loadLang("offline", null, dirname(__FILE__) . DS . "language" . DS);
	}
	...
	public function getName() {
		return Language::_("Offline.name", true);
	}
		...
		$rules = array(
			'instructions' => array(
				'valid' => array(
					'rule' => "isEmpty",
					'negate' => true,
					'message' => Language::_("Offline.!error.instructions.valid", true)
				)
			)
		);
	...
	public function buildProcess(array $contact_info, $amount, array $invoice_amounts=null, array $options=null) {
		...
		// Load the helpers required for this view
		Loader::loadHelpers($this, array("Html", "TextParser"));
