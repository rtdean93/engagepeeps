...
class InvoiceDelivery {
	...
	public function __construct() {
		...
		Loader::loadModels($this, array("Invoices", "Clients", "Contacts", "Companies", "Countries"));
	...
	public function deliverInvoices(array $invoice_ids, $delivery_method, $deliver_to=null, $from_staff_id=null, array $options=null) {
		...
		switch ($delivery_method) {
			case "email":
				...
				$document = $this->buildInvoices($invoices);
			...
			case "postalmethods":
				...
				foreach ($invoices as $invoice_set) {
					...
					$document = $this->buildInvoices($invoice_set, false);
	 ...
	 */
	public function downloadInvoices(array $invoice_ids) {
		$invoices = $this->getInvoices($invoice_ids, true);
		$this->buildInvoices($invoices)->download();
	}
	 ...
	 */
	private function buildInvoices(array $invoices, $include_address=true) {
