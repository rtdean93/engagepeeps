...
$lang['CronTasks.!error.plugin_dir.length'] = "The plugin directory length may not exceed 64 characters.";
...
$lang['CronTasks.!error.type.format'] = "Invalid cron task type.";
