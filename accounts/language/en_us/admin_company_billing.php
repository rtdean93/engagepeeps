...
$lang['AdminCompanyBilling.customization.note_inv_format'] = "Available tags include: {num} - the invoice number (required); {year} - the four-digit year.";
$lang['AdminCompanyBilling.customization.note_inv_draft_format'] = "Available tags include: {num} - the invoice number (required); {year} - the four-digit year.";
