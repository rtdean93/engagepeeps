...
// Types
$lang['Coupons.getTypes.inclusive'] = "Inclusive";
$lang['Coupons.getTypes.exclusive'] = "Exclusive";
...
$lang['Coupons.!error.type.format'] = "Invalid type.";
...
$lang['Coupons.!error.amounts.recurring'] = "Recurring inclusive coupons with a discount option of %1\$s cannot be created because the discount would be taken for each assigned package individually upon renewal."; // %1$s is the coupon discount type "Amount"
