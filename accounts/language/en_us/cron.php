...
$lang['Cron.applycredits.apply_failed'] = "Unable to apply pending credits to transaction %1\$s."; // %1$s is the transaction number
$lang['Cron.applycredits.apply_success'] = "Successfully applied pending credits to transaction %1\$s."; // %1$s is the transaction number
