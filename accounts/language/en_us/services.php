...
$lang['Services.!error.pricing_id.exists'] = "Invalid pricing ID.";
...
$lang['Services.!error.status.valid'] = "Only pending or in review services may be deleted.";
$lang['Services.!error.service_id.has_children'] = "This pending service may not be deleted because it has child services. Please cancel or delete these services and try again.";
