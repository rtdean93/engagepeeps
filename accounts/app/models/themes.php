...
class Themes extends AppModel {
	...
	private $client_theme_colors = array(
		...
		'theme_page_title_button_background_color' => array("theme_page_title_button_background_color_top", "theme_page_title_button_background_color_bottom"),
		'theme_navigation_background_color' => array("theme_navigation_background_color_top", "theme_navigation_background_color_bottom"),
		'theme_navigation_text_color' => array("theme_navigation_text_color"),
	...
	public function getDefault($type = "admin") {
		return $this->Record->select()->from("themes")->where("company_id", "=", null)->
	 ...
	 *		- theme_page_title_button_background_color_top The page title button background hex code for the top gradient
	 *		- theme_page_title_button_background_color_bottom The page title button background hex code for the bottom gradient
