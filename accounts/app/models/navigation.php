		...
		$nav = array(
			...
			$base_uri . "billing/" => array(
				...
				'sub' => array(
					...
					$base_uri . "billing/reports/" => array(
		...
		$nav = array(
			array(
				...
				'children' => array(
					...
					array(
						'name' => $this->_("Navigation.getcompany.nav_general_themes"),
						'uri' => $base_uri ."settings/company/general/themes/"
					),
					array(
	...
	public function getSystem($base_uri) {
		$nav = array(
			...
			array(
				...
				'children' => array(
					...
					array(
						...
						'uri' => $base_uri . "settings/system/help/changelog/"
					),
					array(
			...
			array(
				...
				'class' => "marketplace",
				'uri' => $base_uri . "settings/system/marketplace/"
			)
		);
		return $nav;
	}
