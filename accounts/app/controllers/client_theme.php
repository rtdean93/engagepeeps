...
class ClientTheme extends AppController {
	...
	public function index() {
		...
		if (isset($this->Session)) {		
			// Get theme setting
			$theme_setting = $this->SettingsCollection->fetchSetting($this->Companies, $this->company_id, "theme_client");
			...
			if (isset($theme_setting['value'])) {
				...
				$theme_loc = VIEWDIR . "client" . DS . "default" . DS . "css" . DS . $dir . "theme.css";
