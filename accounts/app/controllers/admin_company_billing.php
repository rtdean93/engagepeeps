...
class AdminCompanyBilling extends AppController {
	...
	public function invoices() {
		...
		if (!empty($this->post)) {
			...
			if (empty($this->post['client_set_invoice']))
				$this->post['client_set_invoice'] = "false";
			if (empty($this->post['inv_suspended_services']))
				$this->post['inv_suspended_services'] = "false";
			if (empty($this->post['clients_cancel_services']))
				$this->post['clients_cancel_services'] = "false";
			if (empty($this->post['auto_apply_credits']))
				$this->post['auto_apply_credits'] = "false";
			if (empty($this->post['auto_paid_pending_services']))
				$this->post['auto_paid_pending_services'] = "false";
	...
	public function customization() {
		...
		$this->uses(array("InvoiceTemplateManager", "Languages"));
		...
		if (!empty($this->post)) {
			// Set checkbox settings if not given
			if (empty($this->post['inv_display_logo']))
				$this->post['inv_display_logo'] = "false";
			if (empty($this->post['inv_display_companyinfo']))
				$this->post['inv_display_companyinfo'] = "false";
	...
	public function notices() {
		...
		if (!empty($this->post)) {
			...
			// Do not store these as settings
