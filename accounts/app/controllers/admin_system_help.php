...
class AdminSystemHelp extends AppController {
	...
	public function changelog() {
		...
		// Find the changelog on the file system and set it in the view
		$changelog = dirname(ROOTWEBDIR) . DS . "changelog.txt";
		if (file_exists($changelog))
			$this->set("changelog", file_get_contents($changelog));
	}
}
?>